...
const getDeliveriesPerDriver = (deliveries) => {
  // Copied code from https://stackoverflow.com/questions/40774697/how-can-i-group-an-array-of-objects-by-key and I make some updates in it.
  return deliveries.reduce((groupObj, current) => {
    groupObj[current.driverId] = groupObj[current.driverId] || [];
    groupObj[current.driverId].push(current);
    return groupObj;
  }, {});
};
